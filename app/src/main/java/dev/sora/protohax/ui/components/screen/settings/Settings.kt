...
object Settings {
	...
	val enableChinese = BoolSetting(R.string.settings_language_cn, R.string.setting_chinese, "ENABLE_CHINESE", false) {
		MinecraftRelay.updateChinese()
	}
...
//	const val KEY_INTERNET_PROTOCOL_DEFAULT = "auto"
	...
	val settings = arrayOf(offlineSessionEncryption, enableCommandManager, enableRakReliability, enableChinese, trustClicks, ipv6Status)
